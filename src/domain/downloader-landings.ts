...
export const downloaderLandingDictionary: DownloaderLandingDictionary = {
  en: {
    aria2: {
      ...
      overviewBody:
        'If you already run aria2 on a NAS, VPS, seedbox, or home server, BitRemote gives you a native interface on iPhone, iPad, and Mac for checking progress and controlling download tasks while you are away from your main machine.',
    ...
    qbittorrent: {
      ...
      primaryKeyword: 'qbittorrent remote control app',
      seoTitle: 'BitRemote for qBittorrent | qBittorrent Remote Control App',
      seoDescription:
      ...
      heroTitle: 'Use BitRemote as a qBittorrent remote control app.',
      heroBody:
        'BitRemote helps you stay on top of qBittorrent queues from iPhone, iPad, and Mac, with a cleaner mobile-friendly view of remote download activity and task controls.',
      overviewTitle: 'Why use BitRemote with qBittorrent',
      overviewBody:
        'qBittorrent is powerful, but the desktop web workflow is not always ideal on mobile devices. BitRemote gives you a dedicated interface on iPhone, iPad, and Mac for remote task management and status checks.',
      capabilityTitle: 'What you can do',
      capabilityItems: [
        'Monitor qBittorrent queues and transfer activity remotely.',
        'Pause, resume, remove, and add qBittorrent tasks from iPhone, iPad, and Mac.',
      ...
      useCaseItems: [
        ...
        'Access your qBittorrent server from iPhone, iPad, and Mac with one app.',
      ],
    },
    transmission: {
      slug: 'transmission',
      clientName: 'Transmission',
      primaryKeyword: 'transmission remote control app',
      seoTitle: 'BitRemote for Transmission | Transmission Remote Control App',
      seoDescription:
      ...
      heroTitle: 'Manage Transmission from iPhone, iPad, and Mac.',
      heroBody:
      ...
      useCaseTitle: 'How BitRemote helps with your workflow',
      useCaseItems: [
        'Check Transmission activity while away from your server.',
    ...
    'synology-download-station': {
      ...
      primaryKeyword: 'synology download station remote control app',
      seoTitle: 'BitRemote for Synology Download Station | Remote Control App',
      seoDescription:
    ...
    'qnap-download-station': {
      ...
      primaryKeyword: 'qnap download station remote control app',
      seoTitle: 'BitRemote for QNAP Download Station | Remote Control App',
      seoDescription:
  ...
  'zh-hant': {
    aria2: {
      slug: 'aria2',
      clientName: 'aria2',
      primaryKeyword: 'aria2 遠端控制工具',
      seoTitle: 'BitRemote for aria2 | aria2 遠端控制工具',
      seoDescription:
      ...
      overviewBody:
        '如果你的 aria2 執行在 NAS、VPS、seedbox 或家用伺服器上，BitRemote 能在 iPhone、iPad 與 Mac 上提供更適合日常管理的遠端介面。',
    ...
    qbittorrent: {
      slug: 'qbittorrent',
      clientName: 'qBittorrent',
      primaryKeyword: 'qBittorrent 遠端控制工具',
      seoTitle: 'BitRemote for qBittorrent | qBittorrent 遠端控制工具',
      seoDescription:
        '在 iPhone、iPad 與 Mac 上用 BitRemote 遠端管理 qBittorrent。隨時查看佇列、監控活動並控制 qBittorrent 任務。',
      heroTitle: '把 BitRemote 當成你的 qBittorrent 遠端控制工具',
      heroBody:
        'BitRemote 幫助你在 iPhone、iPad 與 Mac 上更輕鬆查看 qBittorrent 佇列、掌握活動狀態，並快速執行任務操作。',
      overviewTitle: '為什麼搭配 qBittorrent 使用 BitRemote',
      overviewBody:
        'qBittorrent 功能很完整，但在行動裝置上不一定好操作。BitRemote 提供更專注的 iPhone、iPad 與 Mac 介面來處理遠端任務管理。',
      capabilityTitle: '主要功能',
      capabilityItems: [
        '遠端監控 qBittorrent 佇列與傳輸活動',
        '從 iPhone、iPad 與 Mac 暫停、恢復、刪除與新增 qBittorrent 任務',
        '不用依賴桌面瀏覽器也能篩選與檢查任務',
      ],
      useCaseTitle: 'BitRemote 如何幫助你最佳化工作流程',
      useCaseItems: [
        ...
        '用同一個 App 在 iPhone、iPad 與 Mac 上存取你的 qBittorrent 伺服器',
      ],
    },
    transmission: {
      slug: 'transmission',
      clientName: 'Transmission',
      primaryKeyword: 'Transmission 遠端控制工具',
      seoTitle: 'BitRemote for Transmission | Transmission 遠端控制工具',
      seoDescription:
        '在 iPhone、iPad 與 Mac 上用 BitRemote 遠端控制 Transmission。隨時監控傳輸活動、管理佇列並更新遠端任務。',
      heroTitle: '用 iPhone、iPad 與 Mac 管理 Transmission',
      heroBody:
        'BitRemote 為 Transmission 使用者提供專注的遠端控制工具，方便在 iPhone、iPad 與 Mac 上查看佇列與傳輸狀態。',
    ...
    'synology-download-station': {
      slug: 'synology-download-station',
      clientName: 'Synology Download Station',
      primaryKeyword: 'Synology Download Station 遠端控制工具',
      seoTitle: 'BitRemote for Synology Download Station | 遠端控制工具',
      seoDescription:
        '在 iPhone、iPad 與 Mac 上用 BitRemote 遠端管理 Synology Download Station。隨時查看任務、佇列與下載活動。',
      heroTitle: 'Synology Download Station 的遠端控制工具',
      heroBody:
    ...
    'qnap-download-station': {
      slug: 'qnap-download-station',
      clientName: 'QNAP Download Station',
      primaryKeyword: 'QNAP Download Station 遠端控制工具',
      seoTitle: 'BitRemote for QNAP Download Station | 遠端控制工具',
      seoDescription:
  ...
  'zh-hans': {
    aria2: {
      slug: 'aria2',
      clientName: 'aria2',
      primaryKeyword: 'aria2 远程管理工具',
      seoTitle: 'BitRemote for aria2 | aria2 远程管理工具',
      seoDescription:
      ...
      overviewBody:
        '如果你的 aria2 运行在 NAS、VPS、seedbox 或家庭服务器上，BitRemote 能在 iPhone、iPad 和 Mac 上提供更适合日常使用的远程管理界面。',
      capabilityTitle: '主要功能',
      capabilityItems: [
    ...
    qbittorrent: {
      slug: 'qbittorrent',
      clientName: 'qBittorrent',
      primaryKeyword: 'qBittorrent 远程管理工具',
      seoTitle: 'BitRemote for qBittorrent | qBittorrent 远程管理工具',
      seoDescription:
        '在 iPhone、iPad 和 Mac 上用 BitRemote 远程管理 qBittorrent。随时查看队列、监控活动并控制 qBittorrent 任务。',
      heroTitle: '把 BitRemote 当作你的 qBittorrent 远程管理工具',
      heroBody:
        'BitRemote 帮助你在 iPhone、iPad 和 Mac 上更轻松地查看 qBittorrent 队列、掌握活动状态，并快速执行任务操作。',
      overviewTitle: '为什么搭配 qBittorrent 使用 BitRemote',
      overviewBody:
        'qBittorrent 功能强大，但在移动设备上不一定好操作。BitRemote 提供更专注的 iPhone、iPad 和 Mac 界面来处理远程任务管理。',
      capabilityTitle: '主要功能',
      capabilityItems: [
        '远程监控 qBittorrent 队列与传输活动',
        '从 iPhone、iPad 和 Mac 暂停、恢复、删除与新增 qBittorrent 任务',
        '不用依赖桌面浏览器也能筛选与检查任务',
      ],
      useCaseTitle: 'BitRemote 如何帮助你优化工作流',
      useCaseItems: [
        ...
        '用同一个 App 在 iPhone、iPad 和 Mac 上访问你的 qBittorrent 服务器',
      ],
    },
    transmission: {
      slug: 'transmission',
      clientName: 'Transmission',
      primaryKeyword: 'Transmission 远程管理工具',
      seoTitle: 'BitRemote for Transmission | Transmission 远程管理工具',
      seoDescription:
        '在 iPhone、iPad 和 Mac 上用 BitRemote 远程控制 Transmission。随时监控传输活动、管理队列并更新远程任务。',
      heroTitle: '用 iPhone、iPad 和 Mac 管理 Transmission',
      heroBody:
        'BitRemote 为 Transmission 用户提供专注的远程管理工具，方便在 iPhone、iPad 和 Mac 上查看队列与传输状态。',
    ...
    'synology-download-station': {
      slug: 'synology-download-station',
      clientName: 'Synology Download Station',
      primaryKeyword: 'Synology Download Station 远程管理工具',
      seoTitle: 'BitRemote for Synology Download Station | 远程管理工具',
      seoDescription:
        '在 iPhone、iPad 和 Mac 上用 BitRemote 远程管理 Synology Download Station。随时查看任务、队列与下载活动。',
      heroTitle: 'Synology Download Station 的远程管理工具',
      heroBody:
    ...
    'qnap-download-station': {
      slug: 'qnap-download-station',
      clientName: 'QNAP Download Station',
      primaryKeyword: 'QNAP Download Station 远程管理工具',
      seoTitle: 'BitRemote for QNAP Download Station | 远程管理工具',
      seoDescription:
  ...
  ja: {
    aria2: {
      slug: 'aria2',
      clientName: 'aria2',
      primaryKeyword: 'aria2 遠隔操作アプリ',
      seoTitle: 'BitRemote for aria2 | aria2 遠隔操作アプリ',
      seoDescription:
      ...
      overviewBody:
        'aria2 を NAS、VPS、seedbox、ホームサーバーで運用しているなら、BitRemote が iPhone、iPad、Mac 向けの扱いやすい管理インターフェースになります。',
      ...
      useCaseItems: [
        ...
        'NAS やホームサーバー上のセルフホスト aria2 を管理',
    ...
    qbittorrent: {
      slug: 'qbittorrent',
      clientName: 'qBittorrent',
      primaryKeyword: 'qBittorrent 遠隔操作アプリ',
      seoTitle: 'BitRemote for qBittorrent | qBittorrent 遠隔操作アプリ',
      seoDescription:
        'iPhone、iPad、Mac で BitRemote を使って qBittorrent をリモート管理。キュー確認、アクティビティ監視、タスク操作をどこからでも行えます。',
      heroTitle: 'qBittorrent 用の遠隔操作アプリとして使う',
      heroBody:
        'BitRemote は iPhone、iPad、Mac で qBittorrent のキュー確認、状態把握、タスク操作を行いやすくする専用アプリです。',
      overviewTitle: 'qBittorrent に BitRemote を使う理由',
      overviewBody:
        'qBittorrent は高機能ですが、モバイルでは操作しづらいことがあります。BitRemote は iPhone、iPad、Mac 向けのリモート管理に集中した UI を提供します。',
      capabilityTitle: '主な機能',
      capabilityItems: [
      ...
      useCaseItems: [
        ...
        'iPhone、iPad、Mac のどれからでも一つのアプリで qBittorrent サーバーにアクセス',
      ],
    },
    transmission: {
      slug: 'transmission',
      clientName: 'Transmission',
      primaryKeyword: 'Transmission 遠隔操作アプリ',
      seoTitle: 'BitRemote for Transmission | Transmission 遠隔操作アプリ',
      seoDescription:
        'iPhone、iPad、Mac で BitRemote を使って Transmission をリモート操作。転送状況の監視、キュー管理、遠隔タスク更新が可能です。',
      heroTitle: 'iPhone、iPad、Mac から Transmission を管理',
      heroBody:
      ...
      useCaseTitle: 'BitRemote でワークフローを改善する方法',
      useCaseItems: [
        'サーバーから離れていても Transmission の状態を確認',
    ...
    'synology-download-station': {
      slug: 'synology-download-station',
      clientName: 'Synology Download Station',
      primaryKeyword: 'Synology Download Station 遠隔操作アプリ',
      seoTitle: 'BitRemote for Synology Download Station | 遠隔操作アプリ',
      seoDescription:
        'iPhone、iPad、Mac で BitRemote を使って Synology Download Station をリモート管理。タスク、キュー、ダウンロード状況をどこからでも確認できます。',
      heroTitle: 'Synology Download Station 用の遠隔操作アプリ',
      heroBody:
    ...
    'qnap-download-station': {
      slug: 'qnap-download-station',
      clientName: 'QNAP Download Station',
      primaryKeyword: 'QNAP Download Station 遠隔操作アプリ',
      seoTitle: 'BitRemote for QNAP Download Station | 遠隔操作アプリ',
      seoDescription:
        'iPhone、iPad、Mac で BitRemote を使って QNAP Download Station をリモート操作。キュー状況を監視し、遠隔ダウンロードタスクを管理できます。',
      heroTitle: 'QNAP Download Station の遠隔操作アプリ',
      heroBody:
