...
Any agent making design-related decisions for this project must read [`.impeccable.md`](./.impeccable.md) first and treat it as the source of truth for design direction.
